                ...
                <div class="form-amount">
                    <form class="mt-3" method="POST" action="cust_update_cart.php">
                        ...
                        <div class="d-grid gap-2 d-md-block">
                            ...
                            <!-- <a href="remove_cart_item.php?s_id=<?php echo $cust_id?>&f_id=<?php echo $fd_id?>"><button class="btn btn-outline-danger" type="submit" value="rmv" title="remove from cart" name="rmv_item">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <a href="remove_cart_item.php?s_id=<?php echo $cust_id?>&f_id=<?php echo $fd_id?>" ><button type="submit"></button>remove</a>
                        </div>
                    </form>
                </div>
            </div>
