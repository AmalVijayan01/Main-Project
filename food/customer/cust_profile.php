...
<?php 
    ...
    <title>My Profile | Home-foodi</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container px-5 py-4" id="cart-body">
        ...
        <?php
            ...
            $query = "SELECT tbl_customer.cust_id,tbl_customer.cust_fname,tbl_customer.cust_lname,tbl_customer.cust_email,tbl_customer.cust_mob,tbl_customer.cust_city,tbl_customer.cust_pincode,tbl_login.uname FROM tbl_customer,tbl_login WHERE tbl_customer.login_id={$_SESSION["ses_id"]} and tbl_login.login_id ={$_SESSION["ses_id"]};";
            $result = mysqli_query($con,$query);
            $row = $result -> fetch_array();
        ?>
        <!-- update query ends -->
        <a class="btn btn-sm btn-primary mt-2 mt-md-0" href="cust_update_profile.php?<?php echo "cus_id=".$row["cust_id"]?>">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <div class="row row-cols-1 mt-4">
            <dl class="row">
                ...
                <dd class="col-sm-9"><?php echo $row["uname"];?></dd>

                <dt class="col-sm-3">Name</dt>
                <dd class="col-sm-9"><?php echo $row["cust_fname"]." ".$row["cust_lname"];?></dd>

                <dt class="col-sm-3">Email</dt>
                <dd class="col-sm-9"><?php echo $row["cust_email"];?></dd>

                <dt class="col-sm-3">Mobile</dt>
                <dd class="col-sm-9"><?php echo $row["cust_mob"];?></dd>

                <dt class="col-sm-3">City</dt>
                <dd class="col-sm-9"><?php echo $row["cust_city"];?></dd>

                <dt class="col-sm-3">Pincode</dt>
                <dd class="col-sm-9"><?php echo $row["cust_pincode"];?></dd>
