                    ...
                    <div class="table-responsive m-t-40">
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                WHERE tbo.chef_id='$chefid' AND tbo.order_status='prep'
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <?php 
                                                ...
                                                {
                                            ?>
                                            <a href="action_accept_order.php?<?php echo "pid=".$odr_id ?>" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5">Out for delivery</a>
                                            <?php
                                                }
                                                else{
                                                   ?>
