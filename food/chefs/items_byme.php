...
>>>>>>> e937fb11643b7fff3d41a5b4399541e176c9e127
            ...
            <?php
                $select_query = "SELECT tbl_foods.food_id,tbl_foods.food_name,tbl_foods.food_description,
                                    tbl_foods.food_qty,tbl_foods.food_unitprice,tbl_foods.food_image,
                                    tbl_foods.chef_id,tbl_foods.cat_id,tbl_foods.food_status,tbl_chefs.chef_fname,
                                    tbl_chefs.chef_lname,tbl_category.cat_name FROM tbl_foods,tbl_chefs,
                                    tbl_category WHERE tbl_foods.chef_id=tbl_chefs.chef_id AND 
                                    tbl_foods.cat_id=tbl_category.cat_id AND tbl_chefs.login_id='$login_id'";
