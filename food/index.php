...
<body>
	...
	<!---header--->
	<header>
		<a href="#" class="logo">Home-Foodie</a>
		...
		<ul class="navbar">
			...
			<li><a href="#team">Our Chefs</a></li>
			<li><a href="#contact">Contact</a></li>
			<li><a href="customer/cust_regist.php">Sign up</a></li>
		</ul>
	...
	<section class="home" id="home">
		<div class="home-text">
			<h3>Welcome</h3>
			<h1>Enjoy Pure home made foods</h1>
			<p>Home-Foodie is a food delivery app focus on delivering home-made foods only <br> From trusted home chefs</p>
			<a href="customer/cust_login.php" class="btn">Sign In</a>
		</div>
	...
	<section class="team" id="team">
		<div class="center-text">
			...
			<div class="top-btn">
			<a href="chefs/chef_signup.php">Join with us</a>
		</div>
		</div>
	...
	<section class="blog" id="blog">
		...
		<div class="blog-content">
			<div class="main">
				...
				<div class="blog-text">
					<h6>June 10, 2022</h6>
					<h4>Labor Depar rules pro as tweaks overtime</h4>
	...
	<section class="contact" id="contact">
		...
		<div class="contact-box address">
			<h3>Conatct</h3>
			<i class='bx bxs-map' ><span>1294 Mockingbird Hill, NYC</span></i>
			<i class='bx bxs-envelope' ><span>hello@yourmail.com</span></i>
			<i class='bx bxs-phone' ><span>(00) 123 456 789</span></i>
		</div>
