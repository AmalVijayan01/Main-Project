        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Delivery agents details</h3>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="fdopr">
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $Selectquery = "SELECT tbl_login.*,tbl_agents.* from tbl_login,tbl_agents where tbl_login.login_id=tbl_agents.login_id;";
                                            // $Selectquery = "SELECT * FROM customers";
                                            $res = mysqli_query($con, $Selectquery);
                                            while ($result = mysqli_fetch_array($res)) {
                                                $imageurl = "userimages/" . $result['agent_photo'];
                                                $imageurl1 = "userimages/" . $result['agent_idproof'];
                                            ?>
                                                <tr>
                                                    <td><?php echo $result['agent_fname']?></td>
                                                    <td><?php echo $result['agent_addr']; ?></td>
                                                    <td><?php echo $result['agent_email']; ?></td>
                                                    <td><?php echo $result['agent_mob']; ?></td>
                                                    <td><img style="width:100px; height:100px;" src="<?php echo $imageurl ?>"></td>
                                                    <td><img style="width:100px; height:100px;" src="<?php echo $imageurl1 ?>"></td>
                                                    <td><?php
                                                        if ($result['status'] == 0) {
                                                            echo "active" ;
                                                        } else {
                                                    ...
                                                    <td>
                                                        <a href="db/enableagent.php?id=<?php echo $result['login_id']?>" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5">Enable</a>
                                                        <a href="db/suspendagent.php?lid=<?php echo $result['login_id']?>" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10">Suspend</a>
                                                    </td>
