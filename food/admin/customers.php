                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $Selectquery = "SELECT tbl_login.*,tbl_customer.* from tbl_login,tbl_customer where tbl_login.login_id=tbl_customer.login_id;";
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="db/enablecust.php?id=<?php echo $result['login_id']; ?> " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5">Enable</a>
                                                        <a href="db/suspendcust.php?lid=<?php echo $result['login_id'] ?>" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10 ">Disable</a>
                                                    </td>
                                                    <?php
