                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            $qry = "select tbl_foods.food_name,tbl_foods.food_image,tbl_foods.food_id,tbl_foods.food_image,tbl_foods.food_unitprice,tbl_foods.food_status,tbl_chefs.chef_fname,tbl_chefs.chef_id from tbl_foods,tbl_chefs where tbl_foods.chef_id = tbl_chefs.chef_id  ORDER BY food_id DESC";
                                            $res4 = mysqli_query($con, $qry);

                                            while ($reslts = mysqli_fetch_array($res4)) {
                                                $imageurl = "foodimages/" . $reslts['food_image'];
                                            ?>
                                                <tr>
                                                    <td>1</td>                      
                                                    <td><?php echo $reslts['food_name']; ?></td>
                                                    <td><img style="width:100px; height:100px;" src="<?php echo $imageurl ?>"></td>
                                                    <td><?php echo $reslts['food_unitprice']; ?></td>
                                                    <td> Chef <?php echo $reslts['chef_fname']; ?></td>
                                                    <td><?php

                                                        if ($reslts['food_status'] == 0) {
                                                            echo "Available";
                                                        } else {
                                                            echo "Not Available";
                                                        }
                                                    ...
                                                    <td><a href="db/suspendfoods.php?id=<?php echo $reslts['food_id'] ?>" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10">Suspend</a>
                                                        <a href="db/enablefood.php?hid=<?php echo $reslts['food_id'] ?>" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5">Enable</a>
                                                    </td>
                                                </tr>
                                            <?php
