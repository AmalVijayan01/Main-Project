        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Contact chef</h3>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="card card-outline-primary">
                        <div class="card-header">
                            <h4 class="m-b-0 text-white">Chef details</h4>
                        </div>
                        <div class="card-body">
                            <?php 
                                $rid = $_GET['fid'];
                                $myqry5="select * from tbl_chefs,tbl_delivery where tbl_delivery.chef_id=tbl_chefs.chef_id and tbl_delivery.del_id=$rid";
                            ...
                            <text><?php echo $res5['chef_fname'] ?></text><br>
                            <label>Address:</label>
                            <text><?php echo $res5['chef_address'] ?></text><br>
                            <label>Email:</label>
                            <text><?php echo $res5['chef_email'] ?></text><br>
                            <label>Mobile:</label>
                            <text><?php echo $res5['chef_mobile'] ?></text><br>
                            </div>
                        </div>
                    </div>
                </div>
