        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Complaints</h3>
                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card card-outline-primary">
                                <div class="card-header">
                                    <h4 class="m-b-0 text-white">Complaints</h4>
                                </div>
                                <div class="card-body">
                                            ...
                                            <div class="row p-t-20">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group has-danger">
                                                        ...
                                                        <input type="text" name="addr" class="form-control form-control-danger" placeholder="Address">
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            </div>
                                            ...
                                            <div class="row p-t-20">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group has-danger">
                                                        ...
                                                        <input type="text" name="mobile" class="form-control form-control-danger" placeholder="Mobile">
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="date" class="form-control form-control-danger" placeholder="Date">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <h3 class="box-title m-t-40"> Complaint</h3>
                                            <hr>
                                            <div class="row">
                                                <div class="col-md-12 ">
                                                    <div class="form-group">
                                ...
                                <div class="form-actions">
                                    ...
                                    <a href="allcomplaints.php" class="btn btn-inverse">Cancel</a>
                                </div>
                                </form>
                            </div>
                        </div>
