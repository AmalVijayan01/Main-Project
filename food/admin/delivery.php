                                        ...
                                        <tbody>
                                            ...
                                            if($stat==0){
                                                ...
                                                <?php
                                                 ...
                                                 if($stat=="dispatch"){ 
                                                ?>
                                                <td> <button type="button" class="btn btn-info" style="font-weight:bold;"><span class="fa fa-bars"  aria-hidden="true" >Dispatched</button></td>
                                                <?php 
                                                 }
                                                 if($stat=="outfordel"){
                                                 ?>
                                                 <td> <button type="button" class="btn btn-warning"><span class="fa fa-cog fa-spin"  aria-hidden="true" ></span>Out for delivery</button></td>
                                                 <?php }
                                                 if($stat=="delivered"){
                                                 ?>
