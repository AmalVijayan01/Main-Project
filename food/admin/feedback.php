        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">View feedbacks</h3>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="card card-outline-primary">
                        <div class="card-header">
                            <h4 class="m-b-0 text-white">View feedback</h4>
                        </div>
                        <div class="card-body">
                            <?php 
                                $rid = $_GET['fid'];
                                $myqry5="SELECT tbl_feedback.*,tbl_login.uname,tbl_login.role from tbl_feedback,tbl_login WHERE feedback_id='$rid' and tbl_feedback.login_id=tbl_login.login_id";
                            ...
                            <text><?php echo $res5['uname'];?></text><br>
                            <label>Role:</label>
                            <text><?php echo $res5['role'];?></text><br>
                            <label>Message:</label>
                            <text><?php echo $res5['message'];?></text><br>
                            <label>Date:</label>
                            <text><?php echo $res5['feedback_date'];?></text><br>
                            </div>
                        </div>
                    </div>
                </div>
