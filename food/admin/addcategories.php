                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Delivery</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="agentreq.php">Add Agents</a></li>
        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Add new categories</h3>
                </div>
                            ...
                            <form action='#' method='POST'>
                                <div class="form-body">
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="cname" class="form-control" placeholder="Category Name" autocomplete="off" required>
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="form-actions">
                                        <input type="submit" name="submit" class="btn btn-success" value="Save" onsubmit="return addcategories.php">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Recently Added category</h4>
                        ...
                        <table id="myTable" class="table table-bordered table-striped">
                                    ...
                                    <?php
                                    $myqry2 = "Select * from tbl_category order by cat_id desc limit 1";
                                    $myres2 = mysqli_query($con, $myqry2);

                                    while ($res2 = mysqli_fetch_array($myres2)) {

                                    ?>
                                        <tbody style="text-align: center">
                                            <tr>
                                                <td><?php echo $res2['cat_name']; ?></td>
                                                <td><?php echo $res2['cat_descri']; ?></td>
                                                <td><?php echo $res2['cat_dateadded']; ?></td>
                                                <td>
                                                    <?php

                                                    if ($res2['cat_status'] == 0) {
                                                        echo "Enabled";
                                                    } else {
                                                        echo "Disabled";
                                                    }
                                                ...
                                                <!-- <td style="text-align: center"><a href="delete category" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a>
