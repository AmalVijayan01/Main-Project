        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Available Chefs</h3>
                </div>
                                    ...
                                    <div class="fdopr">
                                        <!-- <div class="fdsort">
                                            <select name="fdsort">
                                                ...
                                                <option value="">Suspended chefs</option>
                                                <option value="">Active chefs</option>
                                            </select>
                                        </div> -->
                                        <!-- <div class="fdsearch">
                                            <input type="search" placeholder="search chefs...">
                                        </div> -->
                                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="db/enablechef.php?id=<?php echo $result['login_id'] ?>" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5">Enable</a>
                                                        <a href="db/suspendchef.php?lid=<?php echo $result['login_id'] ?>" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10">Suspend</a>
                                                    </td>
                                                    <?php
                                            }
            ?>
