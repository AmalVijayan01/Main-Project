        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Available categories</h3>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive m-t-40">
                                <table id="myTable" class="table table-bordered table-striped">
                                    ...
                                    <?php
                                    $myqry2 = "Select * from tbl_category";
                                        ...
                                        <tbody style="text-align: center">
                                            <tr>
                                                ...
                                                <td><?php
                                                    ...
                                                    ?></td>
                                                <td style="text-align: center"><a href="db/suspendcategory.php?lid=<?php echo $res2['cat_id'] ?> " class="btn btn-danger btn-flat btn-addon btn-xs m-b-10">Suspend</a>
                                                    <a href="db/enablecategory.php?id=<?php echo $res2['cat_id'] ?>" class=" btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5">Enable</a>
