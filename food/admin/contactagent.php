        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Contact  delivery agent</h3>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="card card-outline-primary">
                        <div class="card-header">
                            <h4 class="m-b-0 text-white">Delivery agent details</h4>
                        </div>
                        <div class="card-body">
                        <?php 
                                $oid = $_GET['pid'];
                                $myqry5="select * from tbl_deliveryagents,tbl_delivery where tbl_delivery.agent_id=tbl_deliveryagents.agent_id and tbl_delivery.del_id=$oid";
                                $myres5=mysqli_query($con,$myqry5);
                                $res5=mysqli_fetch_array($myres5);     
                            ?>
                            <div class="feedback" style="text-align:center">
                            <br><br><label>Name:</label>
                            <text><?php echo $res5['agent_fname'] ?></text><br>
                            <label>Address:</label>
                            <text><?php echo $res5['agent_address'] ?></text><br>
                            <label>Email:</label>
                            <text><?php echo $res5['agent_email'] ?></text><br>
                            <label>Mobile:</label>
                            <text><?php echo $res5['agent_mobile'] ?></text><br>
                            </div>
                        </div>
                    </div>
                </div>
